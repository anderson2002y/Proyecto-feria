...
{
    public partial class FrmDevolucion_Venta : Form
    {
        private DateTime FechaInicial;
        private DateTime FechaFinal;
        private string Estado;
        public FrmDevolucion_Venta()
        {
            InitializeComponent();
        ...
        private void FrmDevolucion_Venta_Load(object sender, EventArgs e)
        {
            RefrescarReporte();
        }
        ...
        private void RefrescarReporte()
        {
            ...
            reporte_Devolucion_Venta_Entre_Fechas_Por_EstadoTableAdapter.Fill(ferreteriaDataSet.Reporte_Devolucion_Venta_Entre_Fechas_Por_Estado,FechaInicial,FechaFinal,Estado);
            rv.RefreshReport();
        }
    ...
    {
        Seleccione_una_ópcion,No_Aceptado,Aceptado,Entregado
    }
